...
export const authAPI = {
  ...
  logoutAll: () => 
    api.post<LogoutResponse>('/auth/logout/all'),
    
  testPermissions: () => 
    api.get<TestPermissionsResponse>('/auth/test-permissions'),
    
  masterOnly: () => 
    api.get<MasterOnlyResponse>('/auth/master-only'),
    
  ownerOnly: () => 
    api.get<OwnerOnlyResponse>('/auth/owner-only'),
};
...
export const agenciesAPI = {
  ...
  getAgencies: () => 
    api.get<AgenciesResponse>('/agency'),
    
  getAgency: (id: string) => 
    api.get<AgencyResponse>(`/agency/${id}`),
...
export const itemTypesAPI = {
  ...
  getItemType: (id: string) => 
    api.get<ItemTypeResponse>(`/item-type/${id}`),
